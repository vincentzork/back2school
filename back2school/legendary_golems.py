...
iron_golem_of_acererak_custom_stat_block = legendary_golem_stat_blocks[
    "Iron Golem of Acererak"
]
aegis_fang_golem_custom_stat_block = legendary_golem_stat_blocks["Aegis Fang Golem"]
mithral_golem_of_myth_drannor_custom_stat_block = legendary_golem_stat_blocks[
    "Mithral Golem of Myth Drannor"
]
adamantine_golem_of_undermountain_custom_stat_block = legendary_golem_stat_blocks[
